...
passgen ()
{
    ...
    passgen=$(echo $(for i in $(eval echo "{1..$length}"); do pickfrom /usr/share/dict/words; done))
    echo "With spaces (easier to memorize): $passgen"
    echo "Without (use this as the pass): $(echo $passgen | tr -d ' ')"
}
